...
import { RemixServer, Link as Link$1, Outlet, Meta, Links, ScrollRestoration, Scripts, useLoaderData, useParams } from "@remix-run/react";
...
function AppLayout({ children }) {
  return /* @__PURE__ */ jsxs("div", { className: "flex flex-col min-h-screen bg-gray-50 dark:bg-gray-900 text-gray-900 dark:text-gray-100", children: [
    /* @__PURE__ */ jsx("header", { className: "bg-blue-600 dark:bg-blue-800 text-white shadow-md", children: /* @__PURE__ */ jsxs("nav", { className: "container mx-auto px-4 py-3 flex justify-between items-center", children: [
      /* @__PURE__ */ jsx(Link$1, { to: "/", className: "text-2xl font-bold hover:text-blue-200", children: "JavaLearn" }),
      /* @__PURE__ */ jsxs("div", { className: "space-x-4", children: [
        /* @__PURE__ */ jsx(Link$1, { to: "/", className: "hover:text-blue-200", children: "Dashboard" }),
        /* @__PURE__ */ jsx(Link$1, { to: "/topics", className: "hover:text-blue-200", children: "Java Topics" }),
        /* @__PURE__ */ jsx(Link$1, { to: "/dsa", className: "hover:text-blue-200", children: "DSA Topics" }),
        " ",
        /* @__PURE__ */ jsx(Link$1, { to: "/practice", className: "hover:text-blue-200", children: "Practice" }),
        /* @__PURE__ */ jsx(Link$1, { to: "/activities", className: "hover:text-blue-200", children: "Activities" })
      ] })
    ] }) }),
    /* @__PURE__ */ jsx("main", { className: "flex-grow container mx-auto px-4 py-8", children }),
    /* @__PURE__ */ jsxs("footer", { className: "bg-gray-200 dark:bg-gray-800 text-center py-4 text-sm text-gray-600 dark:text-gray-400", children: [
      "© ",
      (/* @__PURE__ */ new Date()).getFullYear(),
      " JavaLearn by W4U Labs"
    ] })
  ] });
}
const links = () => [
...
function ErrorBoundary$2() {
  return /* @__PURE__ */ jsxs("html", { lang: "en", children: [
    /* @__PURE__ */ jsxs("head", { children: [
      /* @__PURE__ */ jsx("title", { children: "Oops!" }),
      /* @__PURE__ */ jsx(Meta, {}),
      /* @__PURE__ */ jsx(Links, {})
    ] }),
    /* @__PURE__ */ jsxs("body", { children: [
      /* @__PURE__ */ jsx(AppLayout, { children: /* @__PURE__ */ jsxs("div", { className: "text-center py-10", children: [
        /* @__PURE__ */ jsx("h1", { className: "text-2xl font-bold text-red-600", children: "Something went wrong!" }),
        /* @__PURE__ */ jsx("p", { className: "mt-4", children: "We encountered an error. Please try again later." })
      ] }) }),
      /* @__PURE__ */ jsx(Scripts, {})
    ] })
  ] });
...
const javaTopic = (topic) => ({ ...topic, category: "java" });
const dsaTopic = (topic) => ({ ...topic, category: "dsa" });
const topics = [
  // --- Java Topics ---
  javaTopic({
    id: "introduction",
...
async function loader$3({ params }) {
  ...
  const topic = getTopic(params.topicId, "java");
  if (!topic) {
...
const meta$6 = ({ data }) => {
  return [
    { title: `${(data == null ? void 0 : data.title) || "Java Topic"} | JavaLearn` },
    { name: "description", content: `Learn about ${(data == null ? void 0 : data.title) || "this Java topic"}.` }
  ];
};
function CodeExampleDisplay$1({ example, index }) {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "mb-6 bg-gray-100 dark:bg-gray-800 p-4 rounded-lg shadow relative group", children: [
    /* @__PURE__ */ jsx("h4", { className: "text-lg font-semibold mb-2 text-gray-700 dark:text-gray-200", children: example.title }),
    /* @__PURE__ */ jsxs("pre", { className: "bg-gray-200 dark:bg-gray-700 p-3 rounded text-sm overflow-x-auto relative", children: [
      /* @__PURE__ */ jsx("code", { children: example.code.trim() }),
      /* @__PURE__ */ jsx(
        "button",
        {
          onClick: handleCopy,
    ...
    /* @__PURE__ */ jsx("p", { className: "mt-2 text-sm text-gray-600 dark:text-gray-400", children: example.explanation })
  ] }, index);
}
function TopicPage() {
  const topic = useLoaderData();
  return /* @__PURE__ */ jsxs("article", { className: "prose dark:prose-invert max-w-none", children: [
    /* @__PURE__ */ jsx("h1", { className: "text-3xl font-bold mb-4 text-gray-800 dark:text-gray-100", children: topic.title }),
    /* @__PURE__ */ jsx(
      "div",
      {
    ...
    topic.examples && topic.examples.length > 0 && /* @__PURE__ */ jsxs(Fragment, { children: [
      /* @__PURE__ */ jsx("h3", { className: "text-2xl font-semibold mt-8 mb-4 border-t pt-4 text-gray-800 dark:text-gray-100", children: "Examples" }),
      topic.examples.map((example, index) => /* @__PURE__ */ jsx(CodeExampleDisplay$1, { example, index }, index))
    ] })
  ] });
}
function ErrorBoundary$1() {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "bg-red-100 border border-red-400 text-red-700 px-4 py-3 rounded relative", role: "alert", children: [
    ...
    /* @__PURE__ */ jsxs("span", { className: "block sm:inline", children: [
      ' Could not load the Java topic "',
      params.topicId,
      '". It might not exist.'
    ] }),
    /* @__PURE__ */ jsx("p", { children: /* @__PURE__ */ jsx(Link, { to: "/topics", className: "text-blue-600 hover:underline", children: "Return to Java Topics" }) })
  ] });
}
...
function TopicsIndex() {
  const topics2 = useLoaderData();
  return /* @__PURE__ */ jsxs("div", { children: [
    /* @__PURE__ */ jsx("h1", { className: "text-3xl font-bold mb-6 text-gray-800 dark:text-gray-100", children: "Java Topics" }),
    /* @__PURE__ */ jsx("p", { className: "mb-6 text-lg text-gray-600 dark:text-gray-300", children: "Explore fundamental concepts and features of the Java programming language." }),
    /* @__PURE__ */ jsx("div", { className: "space-y-4", children: topics2.map((topic) => /* @__PURE__ */ jsx(
      Link$1,
      {
        to: `/topics/${topic.id}`,
        ...
        children: /* @__PURE__ */ jsx("h2", { className: "text-xl font-semibold text-blue-600 dark:text-blue-400", children: topic.title })
      },
      topic.id
    )) })
  ] });
...
async function loader$1({ params }) {
  invariant(params.topicId, "Missing topicId param");
  const topic = getTopic(params.topicId, "dsa");
  if (!topic) {
    throw new Response("DSA Topic Not Found", { status: 404 });
  }
  return topic;
}
const meta$4 = ({ data }) => {
  return [
    { title: `${(data == null ? void 0 : data.title) || "DSA Topic"} | JavaLearn` },
    { name: "description", content: `Learn about ${(data == null ? void 0 : data.title) || "this DSA topic"}.` }
  ];
};
function CodeExampleDisplay({ example, index }) {
  const [copyState, setCopyState] = useState("idle");
  const handleCopy = async () => {
    if (copyState !== "idle") return;
    setCopyState("copying");
...
function DsaTopicPage() {
  ...
  return /* @__PURE__ */ jsxs("article", { className: "prose dark:prose-invert max-w-none", children: [
    ...
    topic.examples && topic.examples.length > 0 && /* @__PURE__ */ jsxs(Fragment, { children: [
      /* @__PURE__ */ jsx("h3", { className: "text-2xl font-semibold mt-8 mb-4 border-t pt-4 text-gray-800 dark:text-gray-100", children: "Examples" }),
      topic.examples.map((example, index) => /* @__PURE__ */ jsx(CodeExampleDisplay, { example, index }, index))
    ] })
  ] });
}
function ErrorBoundary() {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "bg-red-100 border border-red-400 text-red-700 px-4 py-3 rounded relative", role: "alert", children: [
    /* @__PURE__ */ jsx("strong", { className: "font-bold", children: "Error!" }),
    /* @__PURE__ */ jsxs("span", { className: "block sm:inline", children: [
      ' Could not load the DSA topic "',
      params.topicId,
      '". It might not exist.'
    ] }),
    /* @__PURE__ */ jsx("p", { children: /* @__PURE__ */ jsx(Link$1, { to: "/dsa", className: "text-blue-600 hover:underline", children: "Return to DSA Topics" }) })
  ] });
}
const route3 = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  ErrorBoundary,
  default: DsaTopicPage,
  loader: loader$1,
  meta: meta$4
}, Symbol.toStringTag, { value: "Module" }));
const meta$3 = () => {
...
function Activities() {
  return /* @__PURE__ */ jsxs("div", { children: [
    /* @__PURE__ */ jsx("h1", { className: "text-3xl font-bold mb-6 text-gray-800 dark:text-gray-100", children: "Activities" }),
    /* @__PURE__ */ jsxs("div", { className: "bg-yellow-100 dark:bg-yellow-900 border-l-4 border-yellow-500 text-yellow-700 dark:text-yellow-300 p-4 rounded-md shadow", role: "alert", children: [
      /* @__PURE__ */ jsx("p", { className: "font-bold", children: "Coming Soon!" }),
      /* @__PURE__ */ jsx("p", { children: "Interactive quizzes and coding challenges will be available here shortly." })
    ] })
  ] });
}
...
function DsaTopicsIndex() {
  const topics2 = useLoaderData();
  return /* @__PURE__ */ jsxs("div", { children: [
    /* @__PURE__ */ jsx("h1", { className: "text-3xl font-bold mb-6 text-gray-800 dark:text-gray-100", children: "Data Structures & Algorithms (DSA)" }),
    /* @__PURE__ */ jsx("p", { className: "mb-6 text-lg text-gray-600 dark:text-gray-300", children: "Explore fundamental data structures and algorithms, often implemented or used in Java." }),
    /* @__PURE__ */ jsx("div", { className: "space-y-4", children: topics2.map((topic) => /* @__PURE__ */ jsx(
      Link$1,
      {
        to: `/dsa/${topic.id}`,
        className: "block p-4 bg-white dark:bg-gray-800 rounded-lg shadow hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors",
        children: /* @__PURE__ */ jsx("h2", { className: "text-xl font-semibold text-green-600 dark:text-green-400", children: topic.title })
      },
      topic.id
    )) })
  ] });
...
function Practice() {
  return /* @__PURE__ */ jsxs("div", { children: [
    /* @__PURE__ */ jsx("h1", { className: "text-3xl font-bold mb-6 text-gray-800 dark:text-gray-100", children: "Practice Zone" }),
    /* @__PURE__ */ jsx("p", { className: "mb-4 text-gray-700 dark:text-gray-300", children: "Write and test your Java code here. (Note: Code execution is not yet available in this environment.)" }),
    /* @__PURE__ */ jsxs("div", { className: "bg-white dark:bg-gray-800 p-4 rounded-lg shadow", children: [
      /* @__PURE__ */ jsx(
        "textarea",
        {
...
function Index() {
  const topics2 = getTopics();
  return /* @__PURE__ */ jsxs("div", { children: [
    /* @__PURE__ */ jsx("h1", { className: "text-3xl font-bold mb-6 text-gray-800 dark:text-gray-100", children: "Welcome to JavaLearn!" }),
    /* @__PURE__ */ jsx("p", { className: "mb-8 text-lg text-gray-700 dark:text-gray-300", children: "Your interactive platform to master the Java programming language, from basics to advanced concepts." }),
    /* @__PURE__ */ jsxs("div", { className: "grid md:grid-cols-2 lg:grid-cols-3 gap-6", children: [
      /* @__PURE__ */ jsxs("div", { className: "bg-white dark:bg-gray-800 p-6 rounded-lg shadow hover:shadow-lg transition-shadow", children: [
        /* @__PURE__ */ jsx("h2", { className: "text-2xl font-semibold mb-3 text-blue-600 dark:text-blue-400", children: "Explore Topics" }),
        /* @__PURE__ */ jsx("p", { className: "mb-4 text-gray-600 dark:text-gray-400", children: "Dive into structured lessons covering core Java concepts." }),
        /* @__PURE__ */ jsx(
          Link$1,
          {
            to: "/topics",
        ...
        /* @__PURE__ */ jsxs("ul", { className: "mt-4 space-y-1 text-sm text-gray-500 dark:text-gray-400", children: [
          topics2.slice(0, 3).map((topic) => /* @__PURE__ */ jsxs("li", { children: [
            "- ",
            topic.title
          ] }, topic.id)),
          topics2.length > 3 && /* @__PURE__ */ jsx("li", { children: "- ...and more!" })
        ] })
      ] }),
      /* @__PURE__ */ jsxs("div", { className: "bg-white dark:bg-gray-800 p-6 rounded-lg shadow hover:shadow-lg transition-shadow", children: [
        /* @__PURE__ */ jsx("h2", { className: "text-2xl font-semibold mb-3 text-green-600 dark:text-green-400", children: "Practice Zone" }),
        /* @__PURE__ */ jsx("p", { className: "mb-4 text-gray-600 dark:text-gray-400", children: "Apply what you've learned in our interactive code editor." }),
        /* @__PURE__ */ jsx(
          Link$1,
          {
            to: "/practice",
        ...
        /* @__PURE__ */ jsx("p", { className: "mt-4 text-sm text-gray-500 dark:text-gray-400 italic", children: "(Code execution coming soon!)" })
      ] }),
      /* @__PURE__ */ jsxs("div", { className: "bg-white dark:bg-gray-800 p-6 rounded-lg shadow hover:shadow-lg transition-shadow", children: [
        /* @__PURE__ */ jsx("h2", { className: "text-2xl font-semibold mb-3 text-purple-600 dark:text-purple-400", children: "Activities" }),
        /* @__PURE__ */ jsx("p", { className: "mb-4 text-gray-600 dark:text-gray-400", children: "Test your knowledge with quizzes and challenges." }),
        /* @__PURE__ */ jsx(
          Link$1,
          {
            to: "/activities",
        ...
        /* @__PURE__ */ jsx("p", { className: "mt-4 text-sm text-gray-500 dark:text-gray-400 italic", children: "(Activities coming soon!)" })
      ] })
    ] })
  ] });
}
...
const serverManifest = { "entry": { "module": "/assets/entry.client-RqmoTuga.js", "imports": ["/assets/jsx-runtime-56DGgGmo.js", "/assets/components-BNPumMd5.js"], "css": [] }, "routes": { "root": { "id": "root", "parentId": void 0, "path": "", "index": void 0, "caseSensitive": void 0, "hasAction": false, "hasLoader": false, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": true, "module": "/assets/root-BDprwknn.js", "imports": ["/assets/jsx-runtime-56DGgGmo.js", "/assets/components-BNPumMd5.js"], "css": ["/assets/root-CtlbQHf7.css"] }, "routes/topics.$topicId": { "id": "routes/topics.$topicId", "parentId": "root", "path": "topics/:topicId", "index": void 0, "caseSensitive": void 0, "hasAction": false, "hasLoader": true, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": true, "module": "/assets/topics._topicId-wcPEnwUW.js", "imports": ["/assets/jsx-runtime-56DGgGmo.js", "/assets/components-BNPumMd5.js"], "css": [] }, "routes/topics._index": { "id": "routes/topics._index", "parentId": "root", "path": "topics", "index": true, "caseSensitive": void 0, "hasAction": false, "hasLoader": true, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": false, "module": "/assets/topics._index-BVcOxmCP.js", "imports": ["/assets/jsx-runtime-56DGgGmo.js", "/assets/components-BNPumMd5.js"], "css": [] }, "routes/dsa.$topicId": { "id": "routes/dsa.$topicId", "parentId": "root", "path": "dsa/:topicId", "index": void 0, "caseSensitive": void 0, "hasAction": false, "hasLoader": true, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": true, "module": "/assets/dsa._topicId-URzd8UuN.js", "imports": ["/assets/jsx-runtime-56DGgGmo.js", "/assets/components-BNPumMd5.js"], "css": [] }, "routes/activities": { "id": "routes/activities", "parentId": "root", "path": "activities", "index": void 0, "caseSensitive": void 0, "hasAction": false, "hasLoader": false, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": false, "module": "/assets/activities-CuGWzYSs.js", "imports": ["/assets/jsx-runtime-56DGgGmo.js"], "css": [] }, "routes/dsa._index": { "id": "routes/dsa._index", "parentId": "root", "path": "dsa", "index": true, "caseSensitive": void 0, "hasAction": false, "hasLoader": true, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": false, "module": "/assets/dsa._index-DWLdOQ7N.js", "imports": ["/assets/jsx-runtime-56DGgGmo.js", "/assets/components-BNPumMd5.js"], "css": [] }, "routes/practice": { "id": "routes/practice", "parentId": "root", "path": "practice", "index": void 0, "caseSensitive": void 0, "hasAction": false, "hasLoader": false, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": false, "module": "/assets/practice-mL2PiiIy.js", "imports": ["/assets/jsx-runtime-56DGgGmo.js"], "css": [] }, "routes/_index": { "id": "routes/_index", "parentId": "root", "path": void 0, "index": true, "caseSensitive": void 0, "hasAction": false, "hasLoader": false, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": false, "module": "/assets/_index-DUGaqLsQ.js", "imports": ["/assets/jsx-runtime-56DGgGmo.js", "/assets/components-BNPumMd5.js"], "css": [] } }, "url": "/assets/manifest-8a6be106.js", "version": "8a6be106" };
...
const routes = {
  ...
  "routes/topics.$topicId": {
    id: "routes/topics.$topicId",
    parentId: "root",
    path: "topics/:topicId",
    index: void 0,
    caseSensitive: void 0,
