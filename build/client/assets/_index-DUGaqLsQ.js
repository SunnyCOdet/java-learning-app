import{j as e}from"./jsx-runtime-56DGgGmo.js";import{L as i}from"./components-BNPumMd5.js";const t=a=>({...a,category:"java"}),r=a=>({...a,category:"dsa"}),s=[t({id:"introduction",title:"Introduction to Java",content:`
    ...
    `,examples:[{title:"Hello World",code:`
public class HelloWorld {
  public static void main(String[] args) {
    System.out.println("Hello, World!");
  }
}`,explanation:"This is the traditional first program. It prints 'Hello, World!' to the console. `public static void main(String[] args)` is the main entry point of any Java application."}]}),t({id:"variables",title:"Variables and Data Types",content:`
    ...
    `,examples:[{title:"Declaring Variables",code:`
...
}`,explanation:"This example declares variables of different types (String, int, float, boolean, char) and prints their values."},{title:"Type Casting",code:`
public class TypeCasting {
...
}`,explanation:"Type casting converts a value from one data type to another. Widening casting (smaller type to larger type) is automatic. Narrowing casting (larger type to smaller type) must be done manually using `(type)` and might lead to data loss."}]}),t({id:"control-flow",title:"Control Flow (If/Else, Switch, Loops)",content:`
    ...
    `,examples:[{title:"If/Else Example",code:`
...
}`,explanation:"Checks the value of 'time' and prints an appropriate greeting."},{title:"Switch Example",code:`
public class ControlFlow {
  public static void main(String[] args) {
    int day = 4;
    String dayString;
...
}`,explanation:"Uses a switch statement to find the name of the day based on the integer value. The `break` statement is crucial to prevent 'fall-through' to subsequent cases."},{title:"For Loop Example",code:`
public class ControlFlow {
  public static void main(String[] args) {
...
}`,explanation:"Uses a for loop to print numbers, demonstrating `continue` to skip an iteration and `break` to exit the loop early."},{title:"While Loop Example",code:`
public class ControlFlow {
  public static void main(String[] args) {
    int count = 0;
...
}`,explanation:"Uses a while loop to print the value of 'count' as long as it is less than 3."},{title:"Do-While Loop Example",code:`
public class ControlFlow {
  public static void main(String[] args) {
    int i = 5;
...
}`,explanation:"Uses a do-while loop. The code inside the loop runs once before the condition is checked."}]}),t({id:"methods",title:"Methods",content:`
  ...
  // method body
    ...
    `,examples:[{title:"Simple Method (No Parameters, No Return)",code:`
...
}`,explanation:"Defines and calls a simple static method `printMessage` that takes no arguments and returns nothing (`void`)."},{title:"Method with Parameters and Return Value",code:`
public class Methods {
...
}`,explanation:"The `add` method takes two `int` parameters and returns their sum (`int`). The `main` method calls `add` and uses the returned value."},{title:"Method Overloading",code:`
public class Methods {
...
}`,explanation:"Demonstrates method overloading. Three methods named `addNumbers` exist, but they have different parameter lists (two ints, three ints, two doubles). The compiler determines which method to call based on the arguments provided."}]}),t({id:"classes-objects",title:"Classes and Objects",content:`
  ...
  returnType methodName(parameters) { ... }
    ...
    `,examples:[{title:"Simple Class and Object",code:`
...
}`,explanation:"A `Dog` class is defined with fields and a method. An object `myDog` is created, its fields are set, and its method is called."},{title:"Class with Constructor",code:`
class Car {
  String model;
  int year;
...
public class Constructors {
  public static void main(String[] args) {
...
}`,explanation:"The `Car` class has a constructor that takes `model` and `year` arguments to initialize the object upon creation using `new Car(...)`. This ensures objects are created in a valid initial state."}]}),t({id:"arrays",title:"Arrays",content:`
    ...
    `,examples:[{title:"Creating and Accessing Arrays",code:`
...
}`,explanation:"Demonstrates declaring, instantiating, initializing, accessing, and modifying array elements, and getting the array length."},{title:"Looping Through an Array",code:`
public class ArraysExample {
  public static void main(String[] args) {
...
}`,explanation:"Shows iterating through array elements using both a standard `for` loop (with index) and an enhanced `for` loop (for-each)."},{title:"Multidimensional Arrays",code:`
public class ArraysExample {
    public static void main(String[] args) {
...
}`,explanation:"Demonstrates a 2D array (an array of arrays). Elements are accessed using two indices `[row][column]`. Nested loops are used for iteration."}]}),t({id:"inheritance",title:"Inheritance",content:`
    ...
    `,examples:[{title:"Basic Inheritance",code:`
// Superclass
class Animal {
    String name;
...
}`,explanation:"The `Dog` class extends the `Animal` class, inheriting `name`, `eat()`, and `sleep()`. The `Dog` constructor calls the `Animal` constructor using `super()`. `Dog` adds its own field (`breed`) and method (`bark()`), and overrides the `eat()` method."},{title:"Polymorphism Example",code:`
class Animal {
...
public class PolymorphismTest {
...
}`,explanation:"Polymorphism allows treating objects of subclasses (`Cat`, `Cow`) as objects of their superclass (`Animal`). When a method like `makeSound()` is called on an `Animal` reference, the actual method executed depends on the object's runtime type (the specific subclass instance)."}]}),t({id:"exceptions",title:"Exception Handling",content:`
    ...
    `,examples:[{title:"Basic Try-Catch-Finally",code:`
...
}`,explanation:"The code tries to access an invalid array index inside the `try` block. The `ArrayIndexOutOfBoundsException` is caught by the corresponding `catch` block. The `finally` block executes regardless, and the program continues after the try-catch structure."},{title:"Checked Exception (throws)",code:`
...
}`,explanation:"`readFirstLine` performs file I/O, which can throw `IOException` (a checked exception). Because it doesn't handle it internally, it declares `throws IOException`. The `main` method calls `readFirstLine` and *must* either catch the `IOException` (as shown) or declare `throws IOException` itself."},{title:"Throwing an Exception",code:`
public class ThrowExample {
...
}`,explanation:"The `checkAge` method throws an `ArithmeticException` (an unchecked exception type chosen here for demonstration) if the age is below 18. The `main` method calls `checkAge` within a `try` block and catches the potential exception."}]}),t({id:"arraylist",title:"ArrayList (Collections)",content:`
    ...
    `,examples:[{title:"Creating and Using ArrayList",code:`
...
}`,explanation:"Demonstrates creating an `ArrayList` of Strings, adding, getting, setting, removing elements, checking size and contents, iterating, sorting, and clearing the list."},{title:"ArrayList with Integers (Wrapper Class)",code:`
...
public class ArrayListIntegers {
...
}`,explanation:"Shows using `ArrayList` with the `Integer` wrapper class to store integer values. Java's autoboxing/unboxing feature automatically converts between `int` and `Integer` where needed."}]}),r({id:"big-o",title:"Big O Notation",content:`
    ...
    `,examples:[{title:"O(1) - Constant Time",code:`
// Accessing an element in an array by index
int[] arr = {10, 20, 30, 40, 50};
int element = arr[2]; // This takes the same amount of time regardless of arr's size
System.out.println(element);`,explanation:"Accessing `arr[2]` is a direct memory access. It doesn't matter if the array has 5 or 5 million elements; getting the element at a specific index takes roughly the same, constant amount of time."},{title:"O(n) - Linear Time",code:`
...
System.out.println("Max value: " + maxVal);`,explanation:"To find the maximum value, we potentially have to look at every single element in the array once. If the array size doubles, the time taken roughly doubles. The time grows linearly with the input size `n`."},{title:"O(n²) - Quadratic Time",code:`
...
// Total operations roughly n * n = n²`,explanation:"The inner loop runs `n` times for *each* iteration of the outer loop (which also runs `n` times). This results in approximately `n * n = n²` operations. If the array size doubles, the time taken increases by a factor of four (2²)."}]}),r({id:"stacks",title:"Stacks",content:`
    ...
    `,examples:[{title:"Using java.util.Stack",code:`
...
}`,explanation:"Demonstrates basic stack operations (push, pop, peek, isEmpty, size) using Java's `Stack` class. Notice how 'Dune', the last book pushed, is the first one peeked and popped (LIFO)."},{title:"Using ArrayDeque as a Stack",code:`
...
public class DequeStackExample {
...
}`,explanation:"`ArrayDeque` is generally recommended over `Stack` for LIFO behavior in modern Java. It implements the `Deque` (Double-Ended Queue) interface, which provides stack methods like `push`, `pop`, and `peek`. Note that the string representation might show the 'top' element first."}]}),r({id:"queues",title:"Queues",content:`
    ...
    `,examples:[{title:"Using LinkedList as a Queue",code:`
...
}`,explanation:"Demonstrates basic queue operations (offer, poll, peek, isEmpty, size) using `LinkedList` as the `Queue` implementation. 'Alice', the first customer added, is the first one peeked and polled (FIFO)."},{title:"Using ArrayDeque as a Queue",code:`
import java.util.ArrayDeque;
import java.util.Queue; // Use Queue interface
...
public class QueueArrayDequeExample {
...
}`,explanation:"`ArrayDeque` can also be used as an efficient FIFO queue. It provides the same `Queue` interface methods (`offer`, `poll`, `peek`)."}]}),r({id:"linked-lists",title:"Singly Linked Lists",content:`
    ...
    `,examples:[{title:"Conceptual Node Structure",code:`
...
// List: A -> B -> C -> null
`,explanation:"This shows the basic building block of a linked list: the `Node`. Each node holds data and a reference (`next`) to the subsequent node. We link them together manually here to illustrate the concept."},{title:"Simple Singly Linked List Implementation",code:`
...
`,explanation:"A basic implementation of a Singly Linked List with `addFirst`, `addLast`, and `printList` methods. It shows how nodes are linked and how traversal works. Note that `addLast` requires iterating through the list, making it O(n)."},{title:"Using java.util.LinkedList",code:`
import java.util.LinkedList;
...
public class JavaLinkedListExample {
...
}`,explanation:"Java's `LinkedList` provides a rich set of methods for adding, removing, and accessing elements at both ends and by index. While convenient, remember it's a Doubly Linked List under the hood, and random access (`get(index)`) is O(n) on average."}]}),r({id:"binary-search-trees",title:"Binary Search Trees (BST)",content:`
    ...
    `,examples:[{title:"Conceptual BST Node",code:`
...
/*
    ...
    1  4 7  9
*/
`,explanation:"Defines a generic `TreeNode` for a BST. Each node holds comparable data and references to left and right children. The comment shows a possible structure after inserting several values, maintaining the BST property."},{title:"Simple BST Implementation (Insert & In-order Traversal)",code:`
...
`,explanation:"A basic BST implementation with recursive `insert` and `inOrderRecursive` traversal methods. The `insert` method maintains the BST property by comparing the new data with the current node's data to decide whether to go left or right. In-order traversal visits nodes in sorted order."},{title:"Using Java's TreeSet",code:`
...
public class TreeSetExample {
...
}`,explanation:"Java's `TreeSet` provides a ready-to-use implementation based on a self-balancing BST. It automatically maintains elements in sorted order and ensures uniqueness. Operations like `add`, `contains`, and `remove` are typically O(log n)."}]}),r({id:"sorting-algorithms",title:"Sorting Algorithms",content:`
    ...
    `,examples:[{title:"Bubble Sort Implementation",code:`
...
}`,explanation:"Implements Bubble Sort. It repeatedly compares adjacent pairs and swaps them if needed. The outer loop runs n-1 times, and the inner loop compares adjacent elements. An optimization is added to stop early if a pass completes with no swaps."},{title:"Merge Sort Implementation",code:`
import java.util.Arrays;
...
}`,explanation:"Implements Merge Sort using the Divide and Conquer strategy. It recursively divides the array into halves until single elements remain, then merges the sorted halves back together. Requires extra space (O(n)) for the temporary arrays used during merging."},{title:"Using Arrays.sort()",code:`
import java.util.Arrays;
...
public class BuiltInSort {
...
}`,explanation:"Demonstrates using Java's built-in `Arrays.sort()`. This is the recommended way to sort arrays in practice as it uses highly optimized algorithms (like Timsort or Dual-Pivot Quicksort) providing good performance (O(n log n) average)."}]}),r({id:"searching-algorithms",title:"Searching Algorithms",content:`
    ...
    `,examples:[{title:"Linear Search Implementation",code:`
...
}`,explanation:"Implements Linear Search. It iterates through the array element by element, comparing each with the target. It returns the index if found, otherwise -1. Simple but inefficient for large datasets."},{title:"Binary Search Implementation (Iterative)",code:`
...
}`,explanation:"Implements iterative Binary Search. It requires the input array to be sorted. It repeatedly divides the search interval in half based on comparing the target with the middle element. Much faster (O(log n)) than linear search for large sorted arrays."},{title:"Using Arrays.binarySearch()",code:`
import java.util.Arrays;
...
}`,explanation:"Demonstrates using Java's built-in `Arrays.binarySearch()`. This is the preferred method for binary search on sorted arrays. It returns the index if found, or a negative value `(-(insertion point) - 1)` if not found, which indicates where the element would be inserted."}]})];function o(a){return s}const c=()=>[{title:"JavaLearn - Interactive Java Learning"},{name:"description",content:"Start your journey learning Java interactively!"}];function u(){const a=o();return e.jsxs("div",{children:[e.jsx("h1",{className:"text-3xl font-bold mb-6 text-gray-800 dark:text-gray-100",children:"Welcome to JavaLearn!"}),e.jsx("p",{className:"mb-8 text-lg text-gray-700 dark:text-gray-300",children:"Your interactive platform to master the Java programming language, from basics to advanced concepts."}),e.jsxs("div",{className:"grid md:grid-cols-2 lg:grid-cols-3 gap-6",children:[e.jsxs("div",{className:"bg-white dark:bg-gray-800 p-6 rounded-lg shadow hover:shadow-lg transition-shadow",children:[e.jsx("h2",{className:"text-2xl font-semibold mb-3 text-blue-600 dark:text-blue-400",children:"Explore Topics"}),e.jsx("p",{className:"mb-4 text-gray-600 dark:text-gray-400",children:"Dive into structured lessons covering core Java concepts."}),e.jsx(i,{to:"/topics",className:"inline-block bg-blue-500 hover:bg-blue-600 text-white font-medium py-2 px-4 rounded transition-colors",children:"Start Learning"}),e.jsxs("ul",{className:"mt-4 space-y-1 text-sm text-gray-500 dark:text-gray-400",children:[a.slice(0,3).map(n=>e.jsxs("li",{children:["- ",n.title]},n.id)),a.length>3&&e.jsx("li",{children:"- ...and more!"})]})]}),e.jsxs("div",{className:"bg-white dark:bg-gray-800 p-6 rounded-lg shadow hover:shadow-lg transition-shadow",children:[e.jsx("h2",{className:"text-2xl font-semibold mb-3 text-green-600 dark:text-green-400",children:"Practice Zone"}),e.jsx("p",{className:"mb-4 text-gray-600 dark:text-gray-400",children:"Apply what you've learned in our interactive code editor."}),e.jsx(i,{to:"/practice",className:"inline-block bg-green-500 hover:bg-green-600 text-white font-medium py-2 px-4 rounded transition-colors",children:"Go to Practice"}),e.jsx("p",{className:"mt-4 text-sm text-gray-500 dark:text-gray-400 italic",children:"(Code execution coming soon!)"})]}),e.jsxs("div",{className:"bg-white dark:bg-gray-800 p-6 rounded-lg shadow hover:shadow-lg transition-shadow",children:[e.jsx("h2",{className:"text-2xl font-semibold mb-3 text-purple-600 dark:text-purple-400",children:"Activities"}),e.jsx("p",{className:"mb-4 text-gray-600 dark:text-gray-400",children:"Test your knowledge with quizzes and challenges."}),e.jsx(i,{to:"/activities",className:"inline-block bg-purple-500 hover:bg-purple-600 text-white font-medium py-2 px-4 rounded transition-colors",children:"View Activities"}),e.jsx("p",{className:"mt-4 text-sm text-gray-500 dark:text-gray-400 italic",children:"(Activities coming soon!)"})]})]})]})}export{u as default,c as meta};
